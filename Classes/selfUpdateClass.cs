...
{
    internal class selfUpdateClass
    {
        private readonly string badAppName = "TEPS.Automated.Master.Service.Updater.exe";
        private readonly string goodAppName = "TEPS Automated Master Service Updater.exe";
        private readonly string getByIDNum = "45";
        private readonly string downloadByIDNum = "34";
        ...
        private async Task compareAsync(string json)
        {
            ...
            else if (x < 0)
            {
                ...
                await downloadTaskAsync(badAppName, externalURL1, @"C:\ProgramData\Tyler Technologies\Public Safety\Tyler-Client-Install-Master-Service\Updater");
        ...
        public async Task downloadTaskAsync(string programName, string URL, string location)
        {
        ...
        private async void relableandMove(string location, string app, string sourceFile, string destinationFile)
        {
            ...
            try
            {
                ...
                File.Copy(Path.Combine(@"C:\ProgramData\Tyler Technologies\Public Safety\Tyler-Client-Install-Master-Service\Downloads", sourceFile), Path.Combine(@"C:\ProgramData\Tyler Technologies\Public Safety\Tyler-Client-Install-Master-Service\Downloads\Updater", destinationFile), true);
